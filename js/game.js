...
PortfolioUtils.initPage("../", () => {
  ...
  const questionBank = [
    {
      text: "A machine learning technique where a model learns from labeled data to predict outcomes.",
      options: [
        "Supervised Learning",
      ...
      hint: "Think of a teacher providing correct answers during training.",
      explanation:
        "Supervised learning uses labeled datasets to train models to classify data or predict outcomes.",
    },
    {
      text: "When a model performs well on training data but poorly on unseen data, it's called ___ .",
      options: ["Underfitting", "Overfitting", "Bias", "Variance"],
      correct: 1,
      category: "Model Evaluation",
      hint: "The model memorized the training data too well.",
      explanation:
        "Overfitting happens when a model learns noise and details too specifically, losing generalization.",
    },
    {
      text: "Which neural network architecture is best suited for image recognition tasks?",
      options: ["RNN", "LSTM", "CNN", "GAN"],
      correct: 2,
      category: "Deep Learning",
      hint: "It uses convolution layers to detect spatial hierarchies.",
      explanation:
        "Convolutional Neural Networks (CNNs) are designed to process grid-like data like images.",
    },
    {
      text: "The framework that helps build LLM applications with chains, agents, and memory is called ___ .",
      options: ["TensorFlow", "PyTorch", "LangChain", "Hugging Face"],
      correct: 2,
      category: "LLM Tools",
      hint: "It's named after 'language chains'.",
      explanation:
        "LangChain is the most popular framework for composing LLMs into applications.",
    },
    {
      ...
      options: [
        ...
        "Reinforced Adaptive Gradient",
        "Random Access Generator",
      ],
      correct: 1,
      category: "LLM Techniques",
      hint: "It combines document retrieval with text generation.",
      explanation:
        "RAG retrieves relevant documents from a knowledge base and uses them to ground LLM responses.",
    },
    {
      text: "Which algorithm is used to reduce dimensionality while preserving most variance?",
      options: ["PCA", "t-SNE", "LDA", "K-Means"],
      correct: 0,
      category: "Data Science",
      hint: "It stands for Principal Component Analysis.",
      explanation:
        "PCA transforms features into orthogonal components ordered by variance explained.",
    },
    {
      text: "A technique that randomly turns off neurons during training to prevent overfitting.",
      options: ["Dropout", "BatchNorm", "Early Stopping", "Regularization"],
      correct: 0,
      category: "Deep Learning",
      hint: "It 'drops' units randomly.",
      explanation:
        "Dropout forces the network to learn redundant representations, improving generalization.",
    },
    {
      text: "Which generative model uses a generator and discriminator in a competitive process?",
      options: ["VAE", "GAN", "Diffusion Model", "Autoencoder"],
      correct: 1,
      category: "Generative AI",
      hint: "It's a two-player game between a forger and a detective.",
      explanation:
        "Generative Adversarial Networks (GANs) learn to create realistic data by competing.",
    },
    {
      text: "The measure of how well a model's predictions match the true values.",
      options: ["Accuracy", "Loss", "Precision", "Recall"],
      correct: 0,
      category: "Metrics",
      hint: "It's the ratio of correct predictions over total.",
      explanation: "Accuracy = (TP+TN)/(TP+TN+FP+FN).",
    },
    {
      text: "An algorithm that finds the optimal policy by maximizing cumulative reward.",
      options: ["Q-Learning", "Linear Regression", "KNN", "Decision Tree"],
      correct: 0,
      category: "Reinforcement Learning",
      hint: "It learns a value function for state-action pairs.",
      explanation:
        "Q-Learning is a model-free RL algorithm that learns the value of actions in states.",
    },
    {
      text: "What is the main purpose of a confusion matrix?",
      options: [
      ...
      correct: 0,
      category: "Evaluation",
      hint: "It shows where your classifier gets confused.",
      explanation:
        "A confusion matrix breaks down correct and incorrect predictions by class.",
    },
    {
      text: "Which technique involves starting from a pre-trained model and training further on a specific task?",
      options: ["Transfer Learning", "Fine-tuning", "Zero-shot", "Few-shot"],
      correct: 1,
      category: "Deep Learning",
      hint: "It's like refining a general model for a specialized job.",
      explanation:
        "Fine-tuning adjusts pre-trained weights on a new dataset, usually with a lower learning rate.",
    },
    {
      ...
      options: [
        ...
        "Low-Level Machine",
        "Linear Logic Module",
        "Latent Learning Model",
      ],
      correct: 0,
      category: "LLM Basics",
      hint: "It's the model behind ChatGPT.",
      explanation:
        "Large Language Models (LLMs) are neural networks with billions of parameters trained on text.",
    },
    {
      text: "Which library is best known for deep learning with dynamic computation graphs?",
      options: ["TensorFlow", "PyTorch", "Keras", "JAX"],
      correct: 1,
      category: "Frameworks",
      hint: "It's popular in research due to Pythonic debugging.",
      explanation:
        "PyTorch uses define-by-run graphs, making it intuitive for research.",
    },
    {
      text: "The process of converting text into numerical vectors is called ___ .",
      options: ["Tokenization", "Embedding", "Vectorization", "Normalization"],
      correct: 1,
      category: "NLP",
      hint: "Words become dense vectors in a continuous space.",
      explanation:
        "Word embeddings like Word2Vec or GloVe map words to fixed-length vectors.",
    },
    {
      text: "A metric used for imbalanced classification that averages precision and recall.",
      options: ["F1 Score", "AUC-ROC", "Log Loss", "R2 Score"],
      correct: 0,
      category: "Metrics",
      hint: "It's the harmonic mean of precision and recall.",
      explanation:
        "F1 score is useful when false positives and false negatives have different costs.",
    },
    {
      text: "Which algorithm is used for clustering without labels?",
      options: ["K-Means", "SVM", "Linear Regression", "XGBoost"],
      correct: 0,
      category: "Unsupervised",
      hint: "It partitions data into K groups based on centroids.",
      explanation:
        "K-Means is an iterative centroid-based clustering algorithm.",
    },
    {
      text: "A type of neural network well-suited for sequential data like time series.",
      options: ["CNN", "RNN", "MLP", "Autoencoder"],
      correct: 1,
      category: "Deep Learning",
      hint: "It has recurrent connections that loop back.",
      explanation:
        "Recurrent Neural Networks (RNNs) maintain a hidden state across time steps.",
    },
    {
      text: "What does 'GPU' stand for in AI hardware?",
      options: [
        "General Processing Unit",
        "Graphics Processing Unit",
        "Gradient Parallel Unit",
        "Generative Program Unit",
      ],
      correct: 1,
      category: "Hardware",
      hint: "Originally made for rendering graphics, now accelerates matrix math.",
      explanation:
        "GPUs massively parallelize tensor operations, speeding up deep learning.",
    },
    {
      text: "The practice of automatically adjusting a model's hyperparameters to improve performance.",
      options: [
      ...
      hint: "Searching for the best settings like learning rate.",
      explanation:
  ...
  function loadQuestion() {
    ...
    document.getElementById("q-diff-badge").innerText =
  ...
  function showGameOverScreen(completed) {
    ...
    if (score >= 350) {
      rankIcon = "🏆";
      rankTitle = "AI Master";
      rankSub = "You know your stuff!";
    } else if (score >= 200) {
      rankIcon = "🥈";
      rankTitle = "ML Practitioner";
      rankSub = "Solid understanding!";
    } else if (score >= 100) {
      rankIcon = "🥉";
      rankTitle = "AI Beginner";
      rankSub = "Keep learning!";
    } else {
      rankIcon = "📘";
      rankTitle = "Novice";
      rankSub = "Review the basics and try again.";
    }
  ...
  document
    ...
    .addEventListener("click", () => startGame(currentDifficulty));
